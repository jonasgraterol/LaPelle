...
<form id="formulario" class="niceform">  
	...
	<fieldset>
		...
		<dl>
            ...
            <dd>
            	<input type="text" id="precio" class="fornom" onblur="comaXpunto(this);" size="45" value="<?php echo $row['precio1']; ?>" disabled="disabled"/>
				<label class="err" id="precio-error"> Por favor llene correctamente este campo. </label>
            </dd>
		</dl>
		<dl>
        	<dt><label id="lprecio2" for="precio2">Precio 2:</label></dt>
            <dd>
            	<input type="text" id="precio2" class="fornom" onblur="comaXpunto(this);" size="45" value="<?php echo $row['precio2']; ?>" disabled="disabled"/>
		...
		<dl>
            ...
            <dd>
            	<input type="text" id="precio3" class="fornom" onblur="comaXpunto(this);" size="45" value="<?php echo $row['precio3']; ?>" disabled="disabled"/>
