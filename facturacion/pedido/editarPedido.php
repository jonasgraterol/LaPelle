...
<?php
	...
	//PROXIMA FACTURA
	$s = "select id+1 as prox from factura order by id DESC limit 1;";
	$r = mysql_query($s);
...
<div id="factura" style="display:none;" >
	...
	<fieldset class="action">
		<input type="button" id="botonNuevo" onClick="actualizar('p',<?php echo $id ?>);" value="Despachado" />
    	<input type="button" id="botonGuardar" onClick="facturar('libre')" value="Facturar" />
