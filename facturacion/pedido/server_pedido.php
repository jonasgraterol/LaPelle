<?php
	...
	$aColumnsCopia = array( 'id', 'fec', 'nombreTipoServicio' , 'subtotal' , 'iva', 'total' );
	...
	$aColumnsCopiaSelect = array( 'id', 'date_format(fecha, "%h:%i%p %d/%m/%Y")', '(select c.nombre from cliente c where c.id = t.cliente_id)', 'subtotal', 'iva', 'total');
