	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			$j(document).ready(function() {
				var oTable = $j('#adminTipoArticulo').dataTable( {
					"aoColumnDefs": [
				...
				$j("#adminTipoArticulo tbody").click(function(event) {
					var aData = oTable.fnGetData( event.target.parentNode );
					var iId = aData[0];
					cargarDiv('derecha','administracion/tipoarticulo/editartipoarticulo.php?id='+iId);
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="adminTipoArticulo">
	<thead>
		<tr>
			<th width="20%">Id</th>
