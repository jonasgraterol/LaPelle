...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="consuproveedor">
	<thead>
		<tr>
			<th width="5%">Id</th>
			<th width="15%">Nombre</th>
			<th width="10%">Tel. 1</th>
			<th width="10%">Tel. 2</th>
	...
	<tfoot>
		<tr>
			...
			<th><input type="text" name="search_engine" value="Buscar Telefono 2" class="search_init" /></th>
