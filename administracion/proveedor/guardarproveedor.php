...
if($_POST)
{
	...
	if(!validaLongitud($tel2, 1, 5, 50)) $error =3;
	...
	{	
		...
		else
		{
			...
			{ 
				$sql="INSERT INTO ".$tabla." values(null,'".$nombre."','".$dire."','".$tel1."','".$tel2."','".$correo."',1);";
	...
	if ($accion == "editar")
	{
		...
		else
		{
			...
			{
				//$id= $_GET['id'];
				$sql="UPDATE ".$tabla." SET nombre = '".$nombre."', direccion = '".$dire."', telefono1 = '".$tel1."', telefono2= '".$tel2."', correo = '".$correo."' WHERE id = '".$id."'";
