...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="consuusuario">
	<thead>
		<tr>
			<th width="5%">Id</th>
	...
	<tfoot>
		<tr>
			...
			<th><input type="text" name="search_engine" value="Buscar Usuario" class="search_init" /></th>
