...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="admintiposervicio">
	<thead>
		<tr>
			<th width="20%">Id</th>
	...
	<tfoot>
		<tr>
			...
			<th><input type="text" name="search_engine" value="Buscar Descripcion" class="search_init" /></th>		
		</tr>
	</tfoot>
</table>
