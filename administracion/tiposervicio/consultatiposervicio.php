...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="consutiposervicio">
	<thead>
		<tr>
			<th width="10%">Id</th>
	...
	<tfoot>
		<tr>
			...
			<th><input type="text" name="search_engine" value="Buscar Descripcionn" class="search_init" /></th>		
		</tr>
	</tfoot>
</table>
