...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="admincompra">
	<thead>
		<tr>
			<th width="5%">#</th>
	...
	<tfoot>
		<tr>
			...
			<th><input type="text" name="search_engine" value="Proveedor" class="search_init" /></th>
			<th><input type="text" name="search_engine" value="Factura" class="search_init" /></th>	
			<th><input type="text" name="search_engine" value="Monto" class="search_init" /></th>
			<th><input type="text" name="search_engine" value="Fecha de Compra" class="search_init" /></th>	
			<th><input type="text" name="search_engine" value="Fecha de Registro" class="search_init" /></th>
