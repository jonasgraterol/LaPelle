	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sZeroRecords": "Ningun registro coincidente encontrado",
				"sEmptyTable": "No hay datos disponibles en la tabla",
				"sLoadingRecords": "Cargando...",
				"sInfo": "Mostando del _START_ al _END_ de _TOTAL_ registros",
			 ...
			 */
			this.aLengthMenu = [ [ 10, 25, 50, 100, 500, 1000, -1 ], [ 10, 25, 50, 100, 500, 1000, 'Todo' ] ];
