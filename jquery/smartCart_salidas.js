...
(function($){
    $.fn.smartCart = function(options) {
        ...
        return this.each(function() {
                ...
                // Labels & Messages              
                var labelCartMenuName = 'Salida (_COUNT_)';  // _COUNT_ will be replaced with cart count
                var labelCartMenuNameTooltip = "Salida | Total Servicios: _PRODUCTCOUNT_ | Cantidad Total: _ITEMCOUNT_";
                ...
                var labelPrice = 'Ult. Prec';
                var labelSubtotal = 'Subtotal';
                var labelTotal = 'Gasto Estimado';
                ...
                var messageCartEmpty = "Salida vacia";
                var messageProductEmpty = "No hay Servicios para mostrar";
                var messageProductAddError = "El Servicio no pudo ser agreado";
                var messageItemAdded = 'Servicio agregado a la Salida';
                var messageItemRemoved = 'Servicio eliminado de la Salida';
                ...
                function populateProducts(searchString){
                   ...
                   $(products).each(function(i,n){
                      ...
                      if(isValid && isCategoryValid) {
                          ...
                          var inputQty = $('<input type="text"  size="7"/>').addClass("scTxtQuantity");  
    ...
    $.fn.smartCart.defaults = {
          ...
          productItemTemplate:'<strong><%=pname%></strong> (<%=punidad%>)',
